...
<title>Phabricator reporter</title>

<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="Description" content="Tool to monitor edits in Wikidata in a proper way">

<script src="https://tools.wmflabs.org/phabricator-reporter/https.js"></script>
      ...
      <div class="container">
        <div class="left menu">
          <div class="title item">
            <b>Phabricator reporter</b>
          </div><a href="/phabricator-reporter/" class="launch item">Home</a>
                <a href="//tools.wmflabs.org/" class="launch item">Labs</a>
        </div>

        <div class="right menu">
          <a href="https://github.com/Ladsgroup/Phabricator-Reporter" class="item">Source code</a>
        </div>
      </div>
    </div>
  </div>
